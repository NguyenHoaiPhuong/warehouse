...
func init() {
	fmt.Println("Global logger init")
...
// SetMDBHook : set level for mongodb hook of the global logger
func SetMDBHook(cfg *mdbHook.MongoConfig, level int) {
	globalLogger.addMDBHook(cfg, level)
}
